					 ...
					 */
					 ...
					 if(retorno.status == 'ok'){
					 	...
					 	var tweet = '<article class="tweet hidden">';
					 	    tweet += '<img style="float: left; width: 50px; border-radius: 5px;" src="uploads/'+retorno.foto+'"/>'
				...
				success: function(retorno){
					 ...
					 */
					 ...
					 if(retorno.status == 'ok'){
						...
						$('.restotal .user.hidden').slideDown().promise().done(function(){
							$(this).removeClass('hidden');
						});
					 }else{
				 ...
				 if(type == 'tweets_home' || type == 'tweets_timeline' || type == 'tweets_hashtag'){
				 	...
				 	$.each(retorno.results, function(i, val){
				 		...
				 		var tweet = '<article class="tweet">';
				 		    tweet += '<img style="float: left; width: 50px; border-radius: 5px;" src="'+base+'/uploads/'+retorno.results[i].foto+'"/>'
