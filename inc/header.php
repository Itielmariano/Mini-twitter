...
<html lang="pt-BR">
	<head>
		<meta charset=UTF-8>
		<title>TFM Eventos</title>
		<!---<link href='//fonts.googleapis.com/css?family=Roboto:100,300' rel='stylesheet' type='text/css' />-->
		<link href="<?php echo BASE;?>/css/stylee.css" rel="stylesheet" type="text/css" />
	...
	<header id="header">
		<div class="center">
			...
			<ul class="right">
				...
				<li><a href="<?php echo BASE.'/site';?>">Site</a></li>
				<li><a href="<?php echo BASE.'/perguntas';?>">Perguntas & Respostas</a></li>
			</ul>
		</div>
	</header>
